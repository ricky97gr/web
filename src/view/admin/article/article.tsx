        ...
        switch (record.isShow) {
          case 1:
            return (
              ...
              <Tag color="green"><span style={{ fontSize: 14 }}>已发布</span></Tag>
            )
          case 2:
            return (
              <Tag color="yellowgreen"><span style={{ fontSize: 14 }}>审核中</span></Tag>
            )
          case 3:
            return (
              <Tag color="red"><span style={{ fontSize: 14 }}>封禁中</span></Tag>
            )
          case 5:
            return (
              <Tag color="red"><span style={{ fontSize: 14 }}>已退回</span></Tag>
            )
        }
    ...
    },
    {
      ...
      render: (_, record) => {
        const publishArticle = () => {
          ...
          myFetch({ url: "/admin/article/publish", options: { method: "PUT", body: body } }).then((data) => {
            console.log(data)
          })
        }
        const banArticle = () => {
          ...
          myFetch({ url: "/admin/article/ban", options: { method: "PUT", body: body } }).then((data) => {
            console.log(data)
          })
        }
        const sendBackArticle = () => {
          ...
          myFetch({ url: "/admin/article/sendback", options: { method: "PUT", body: body } }).then((data) => {
            console.log(data)
          })
        }
